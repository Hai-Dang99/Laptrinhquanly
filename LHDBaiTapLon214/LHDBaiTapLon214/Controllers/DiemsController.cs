...
namespace LHDBaiTapLon214.Controllers
{
    public class DiemsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "DiemA,DiemB,DiemC,MaHocPhan")] Diem diem)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "DiemA,DiemB,DiemC,MaHocPhan")] Diem diem)
        {
            if (ModelState.IsValid)
            {
